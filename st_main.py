...
# This script contains the training, validation, and test of the Multimodel Single-Task (ST) model using cross-validation sets for all available annotators   
...
with tf.Session() as sess:
    ...
    pred_binary = utils.get_binary(pred_vector)
    gt_binary = utils.get_binary(gt_vector)
    print(utils.md_performance(gt_binary,pred_binary))
